...
/*
 * Code to display the time from DS3231 module in the serial monitor of Arduino
 * Taken from: https://forum.arduino.cc/t/ds3231-not-working-displays-text-without-date-or-time/590185/4
 * For required libraries see here: https://learn.adafruit.com/adafruit-veml6075-uva-uvb-uv-index-sensor/arduino-test#install-arduino-libraries-4-4
 */
